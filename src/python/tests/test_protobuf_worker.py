...
sys.path.insert(0, str(SOURCE_ROOT / "python/worker/gen"))
...
# Test configuration
WORKER_SCRIPT = SOURCE_ROOT / "python/worker/server.py"
TEST_SOCKET = "/tmp/test-ida-worker-protobuf.sock"
SESSION_ID = "test-protobuf"

# Find a test binary
SAMPLE_PATHS = [
    SOURCE_ROOT / "samples/libcocos2dlua-71cfb5834918bc85ed833ca82917cf67b0bd5f3ff66684f540cf80fd91c259ea.so",
    "/bin/ls",  # Fallback
]
TEST_BINARY = None
